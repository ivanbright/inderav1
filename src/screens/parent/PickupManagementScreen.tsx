        ...
        <View style={styles.container}>
            ...
            <View style={styles.safetyNotice}>
                ...
                <Text style={styles.safetyText}>
                    Only these authorized people can pick up {child.name}. Changes require school verification.
                </Text>
            </View>
            ...
            <View style={styles.statsContainer}>
                <View style={styles.statCard}>
                    <Text style={styles.statNumber}>{child.authorizedPickups?.filter(p => p.isActive).length || 0}</Text>
                    <Text style={styles.statLabel}>Active People</Text>
                </View>
                <View style={styles.statCard}>
                    <Text style={styles.statNumber}>{child.authorizedPickups?.length || 0}</Text>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.content}>
                    {filteredPickups.map(pickup => (
                        <View key={pickup.id} style={[styles.pickupCard, !pickup.isActive && styles.pickupCardInactive]}>
